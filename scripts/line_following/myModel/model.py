...
def create_model():
    ...
    data = ZScoreLayer((224,224,3), name="data_")(data_unnormalized)
    ...
    fc = layers.Reshape((1, 1, -1), name="fc_preFlatten1")(pool5)
    fc = layers.Dense(1, name="fc_")(fc)
    regressionoutput = layers.Flatten()(fc)

    model = keras.Model(inputs=[data_unnormalized], outputs=[regressionoutput])
    return model
